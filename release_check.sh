...
"${PYTHON}" -m py_compile main.py aircraft_readiness.py flight_readiness_records.py operating_profiles.py readiness_audit.py runtime_io.py faa_proxy.py platform_admin_identity.py \
