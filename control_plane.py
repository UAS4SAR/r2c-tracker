...
MANAGED_ACCESS_TERMS_TEXT = (
    ...
    "full responsibility for all access to, use of, reliance on, and "
    "inability to use RID2Caltopo and r2c-tracker, including all operational, "
    "flight, navigation, safety, communications, and incident-command decisions.\n\n"
    "RID2Caltopo and r2c-tracker are provided on a best-effort, \"as is,\" and \"as "
    "available\" basis, with no express or implied warranties or guarantees, "
    "including merchantability, fitness for a particular purpose, non-infringement, "
    "suitability, reliability, availability, accuracy, or completeness. Features "
    "and information may be unavailable, inaccurate, incomplete, or delayed. These "
    "tools provide supplemental situational awareness only and must not be used as "
    "the sole source for navigation, flight safety, communications, or "
    ...
    "reliance on, or inability to use RID2Caltopo or r2c-tracker, including claims "
    "based on negligence, whether known or unknown.\n\n"
    "I understand that California Civil Code section 1542 provides: \"A general "
    ...
    "her settlement with the debtor or released party.\" The organization and I "
    "expressly waive all rights and benefits under section 1542 and accept the risk "
    "that facts, injuries, damages, or claims may exist or later be discovered that "
    "are unknown or unsuspected now or differ from what is currently believed.\n\n"
    "RID2Caltopo is an independent project and is not affiliated with or endorsed by "
    "CalTopo; it uses the CalTopo Teams API. I have read, understand, and voluntarily "
    "agree to this acknowledgment."
)
