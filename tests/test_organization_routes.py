...
class OrganizationRouteFlowTest(unittest.TestCase):
    ...
    def test_platform_adoption_report_loads_database_and_exports_private_rows(self):
        ...
        self.assertIn("<h2>July 2026</h2>", page.text)
        self.assertIn("June 2026", page.text)
        self.assertIn("<strong>1</strong>Recorded flights", page.text)
        self.assertIn("Organizations now inactive", page.text)
        self.assertNotIn("No flights this period", page.text)
        self.assertIn("current partial period is excluded", page.text)
